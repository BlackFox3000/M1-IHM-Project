...
public:
    ...
    void setupUi(QDialog *ResizeWindow)
    {
        ...
        layoutWidget = new QWidget(ResizeWindow);
        layoutWidget->setObjectName(QString::fromUtf8("layoutWidget"));
        layoutWidget->setGeometry(QRect(30, 30, 231, 81));
