...
public:
    ...
    QPushButton *button_modif_infos;
    QWidget *layoutWidget;
    QVBoxLayout *verticalLayout;
    QPushButton *button_creer_album;
    QPushButton *button_ouvrir_album;
    QMenuBar *menubar;
    QMenu *menuFichier;
    QMenu *menuOption;
    QMenu *menuAide;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        background->setGeometry(QRect(210, 10, 83, 29));
        button_modif_infos = new QPushButton(centralwidget);
        button_modif_infos->setObjectName(QString::fromUtf8("button_modif_infos"));
        button_modif_infos->setGeometry(QRect(1050, 450, 171, 51));
        layoutWidget = new QWidget(centralwidget);
        layoutWidget->setObjectName(QString::fromUtf8("layoutWidget"));
        layoutWidget->setGeometry(QRect(10, 580, 231, 67));
        verticalLayout = new QVBoxLayout(layoutWidget);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        button_creer_album = new QPushButton(layoutWidget);
        button_creer_album->setObjectName(QString::fromUtf8("button_creer_album"));

        verticalLayout->addWidget(button_creer_album);

        button_ouvrir_album = new QPushButton(layoutWidget);
        button_ouvrir_album->setObjectName(QString::fromUtf8("button_ouvrir_album"));

        verticalLayout->addWidget(button_ouvrir_album);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        background->setText(QCoreApplication::translate("MainWindow", "C", nullptr));
        button_modif_infos->setText(QCoreApplication::translate("MainWindow", "Modifier informations", nullptr));
        button_creer_album->setText(QCoreApplication::translate("MainWindow", "Cr\303\251er album", nullptr));
        button_ouvrir_album->setText(QCoreApplication::translate("MainWindow", "Ouvrir album", nullptr));
